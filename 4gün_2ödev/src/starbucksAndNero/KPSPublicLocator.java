...
public class KPSPublicLocator extends org.apache.axis.client.Service implements MernisService.KPSPublic {
    ...
    public MernisService.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            MernisService.KPSPublicSoapStub _stub = new MernisService.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (MernisService.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                MernisService.KPSPublicSoapStub _stub = new MernisService.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
